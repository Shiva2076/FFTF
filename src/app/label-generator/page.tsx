...
export default function LabelGenerator() {
  ...
  const handleGenerate = () => {
    try {
      ...
      // 2. Construct the URL - CORRECT PATH to match your file structure
      let targetUrl = `${baseUrl}/display-data/${formData.cropType}`;
      ...
      // 4. Generate QR code using the free API
