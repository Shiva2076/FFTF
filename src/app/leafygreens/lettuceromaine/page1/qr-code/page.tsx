...
export default function QRCodePage() {
  const targetUrl = typeof window !== 'undefined' 
    ? `${window.location.origin}/apps/leafygreens/lettuceromaine/page1`
    : 'https://innofarms.ai/apps/leafygreens/lettuceromaine/page1';
  ...
  const downloadQRCode = () => {
    ...
    link.href = qrCodeUrl;
    link.download = 'leafy-greens-qr-code.png';
