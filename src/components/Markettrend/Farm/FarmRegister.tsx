...
const FarmRegisterModal: FC<FarmRegisterModalProps> = ({
  ...
  const isDashboard = pathname === '/farmsxos';
  const isMarkettrend= pathname === '/markettrend';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      sessionStorage.setItem("selectedFarm", JSON.stringify(createdFarm));
      ...
      >
        ...
        <Box sx={{ mt: 4, display: "flex", gap: 2 ,justifyContent: "center" }}>
          <Button
            variant="outlined"
            onClick={onBack}
            disabled={isDashboard || isMarkettrend}
            sx={{ width: "50%", textTransform: "uppercase", fontWeight: 500,    display: isDashboard || isMarkettrend ? "none" : "inline-flex",
            }}
          >
