      ...
      >
        <CardContent sx={{ p: 1.5, '&:last-child': { pb: 1.5 } }}>
          ...
          <Box sx={{ mb: 2 }}>
            ...
            >
             Our Lollo Rosso, with its frilly, red-tinted leaves, grows efficiently in controlled systems and offers visual appeal for high-end retail and salad mixes. Its compact structure allows dense planting for optimized yield. 
