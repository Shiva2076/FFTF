...
const ProductDescription: FunctionComponent = () => {
  const productDetails = [
    ...
    },
    {
      ...
      label: 'Shelf Life',
      value: '3-4 days (refrigerated)'
    },
    {
      icon: <TimerIcon sx={{ fontSize: 14, color: '#3D550C' }} />,
      label: 'Best Before',
      value: '5 days from the date of harvest'
    },
  ];
      ...
      >
        <CardContent sx={{ p: 1.5, '&:last-child': { pb: 1.5 } }}>
          ...
          <Grid container spacing={1.5} sx={{ mb: 2 }}>
            ...
            <Grid item xs={5}>
              ...
              >
                ...
                <img 
                  src="fresh2/Italian-Basil (11).png" 
                  alt="Romaine Lettuce"
                  style={{
                    width: '100%',
                    height: '100%',
          ...
          <Box sx={{ mb: 2 }}>
            ...
            >
            Basil is one of the most popular CEA crops due to its continuous harvest potential and high market demand. It responds well to hydroponics with optimal yields under consistent light and warm temperatures, supplying fresh herbs to culinary and medicinal markets. 
