  ...
  const productDetails = [
    {
      ...
      label: 'Product Type',
      value: 'Lettuce - Lollo Bionda'
    },
    {
      icon: <LocalOfferIcon sx={{ fontSize: 14, color: '#3D550C' }} />,
      label: 'Weight',
      value: '80-100g per head'
    },
    {
      ...
      >
        <CardContent sx={{ p: 1.5, '&:last-child': { pb: 1.5 } }}>
          ...
          <Box sx={{ mb: 2 }}>
            ...
            >
            Lollo Bionda, with its light-green curly leaves, is well-suited to indoor farms aiming for visual diversity in salad mixes. It grows compactly and delivers premium aesthetics for high-end markets. 
